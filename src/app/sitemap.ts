...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
	...
	return [
		...
		...generateSitemapRoutes(['features', 'technologies', 'documents', 'contacts'], routesUrl, 'monthly', 0.5),
		...
		...generateSitemapPosts(await getDocuments<PostType>(), routesUrl + '/documents/[slug]', 'monthly', 0.5),
	]
}
