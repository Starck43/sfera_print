...
import type {Cases} from "@/components/map/types"
...
const CasesList = () => {
	...
	return (
		<>
			<div className={cls.cases__container} style={{'opacity': `${!data?.results ? 0.3 : 1}`}}>
				{casesContent}
				{data?.next !== null && <div ref={inViewRef} className={classnames(cls, ['cover__wrapper', 'skeleton'])}/>}
			</div>
			{caseDetailContent}
		</>
	)
