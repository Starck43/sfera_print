                ...
                return (
                    ...
                    >
                        <style>{`
                            ...
                            ::part(center) {--media-control-background: rgba(0,0,0, 0.5) !important;padding: 0.8rem; border-radius: 50%; width: var(--controls-width); height: var(--slider-controls-width);}
